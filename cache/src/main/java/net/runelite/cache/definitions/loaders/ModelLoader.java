...
public class ModelLoader {
    public ModelDefinition load(int modelId, byte[] b) throws IOException {
    ...
    private void load1(ModelDefinition model, byte[] var1) throws IOException {
        try (InputStream var2 = new InputStream(var1);
    ...
    private void load2(ModelDefinition model, byte[] var1) throws IOException {
        boolean var2 = false;
        boolean var43 = false;

        try (InputStream var5 = new InputStream(var1);
